...
export UCD_ADMIN_PASSWORD=${UCD_ADMIN_PASSWORD:-admin}
export UCD_RELEASE_NAME=${UCD_RELEASE_NAME:-ucd7112}
export UCDAGENT_RELEASE_NAME=${UCDAGENT_RELEASE_NAME:-ucdagent7112}
